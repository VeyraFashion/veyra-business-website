  ...
  return (
    <section className="wrap section" id="how">
      <Reveal className="section-head center">
        ...
        <p className="section-sub">You keep your stack — your PDP, your cart, your checkout. EditMe sits behind it.</p>
      </Reveal>
      <RevealGroup className="steps" stagger={0.12}>
        ...
        <RevealItem className="step">
          ...
          <p>
            Call our API endpoints directly, or embed EditMe&rsquo;s
